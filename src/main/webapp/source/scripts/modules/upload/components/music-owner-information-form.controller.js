(function (angular) {
    ...
    MusicOwnerInformationFormController.$inject = ['$rootScope', 'musicContributions', 'musicianRoles'];

    function MusicOwnerInformationFormController($rootScope, musicContributions, musicianRoles) {
